...
const float ASTEROIDS_OBSTACLE_SPAWN_INTERVAL = 30.0f;
const float ASTEROIDS_OBSTACLE_BLACKHOLE_SPEED = 100.0f;
const float ASTEROIDS_OBSTACLE_GAMMARAY_SPEED = 1500.0f;
const float ASTEROIDS_OBSTACLE_LIFESPAN = 10.0f;

const float ASTEROIDS_ENEMY_BOSS_BASE_HP = 10.0f; // 150
const float ASTEROIDS_ENEMY_BOSS_SPAWN_INTERVAL = 5.0f; // change to 60!
