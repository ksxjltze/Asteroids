...
const float ASTEROIDS_WEAPON_RAILGUN_PROJECTILE_SPEED = 300;
...
const int ASTEROIDS_UPGRADES_FUEL_UPGRADE_COST = 100;

const float ASTEROIDS_UPGRADES_MAX_HEALTH_UPGRADE_AMOUNT = 10.0f;
const int ASTEROIDS_UPGRADES_MAX_HEALTH_UPGRADE_COST = 100;

const float ASTEROIDS_UPGRADES_BULLET_DAMAGE_UPGRADE_AMOUNT = 0.5f;
const int ASTEROIDS_UPGRADES_BULLET_DAMAGE_UPGRADE_COST = 200;

const float ASTEROIDS_UPGRADES_MOVEMENT_SPEED_UPGRADE_AMOUNT = 10.0f;
const int ASTEROIDS_UPGRADES_MOVEMENT_SPEED_UPGRADE_COST = 100;

const float ASTEROIDS_UPGRADES_FIRE_RATE_UPGRADE_AMOUNT = 50.0f;
const int ASTEROIDS_UPGRADES_FIRE_RATE_UPGRADE_COST = 300;

const float ASTEROIDS_UPGRADES_PROJECTILE_SPEED_UPGRADE_AMOUNT = 50.0f;
const int ASTEROIDS_UPGRADES_PROJECTILE_SPEED_UPGRADE_COST = 200;
...
const float ASTEROIDS_ENEMY_BOSS_BASE_HP = 150.0f; // 150
const float ASTEROIDS_ENEMY_BOSS_SPAWN_INTERVAL = 60.0f; // change to 60!
const float ASTEROIDS_ENEMY_BOSS_SPEED = 20.0f;

const float ASTEROIDS_FINAL_BOSS_PROJECTILE_ANGLE = 15.0f;
const int ASTEROIDS_FINAL_BOSS_PROJECT_NUM = 5;
...
const float ASTEROIDS_FINAL_BOSS_FIRE_RATE = 10000.0f;