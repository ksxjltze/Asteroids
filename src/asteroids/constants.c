...
const float ASTEROIDS_DIFFICULTY_INTERVAL = 2.0f;
...
const float ASTEROIDS_FINAL_BOSS_STATE_CHANGE_RATE = 20.0f;
const float ASTEROIDS_FINAL_BOSS_IDLE_STATE_FIRE_RATE = 100.0f;