...
const int ASTEROIDS_UPGRADES_MULTISHOT_UPGRADE_COST = 20000;
...
const float ASTEROIDS_DIFFICULTY_INTERVAL = 500.0f;// ChAng
...
const int ASTEROIDS_FINAL_BOSS_SUMMON_CRITERIA = 2020; //2020??
