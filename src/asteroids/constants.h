...
extern const float ASTEROIDS_CURRENCY_EARNING_BALANCE_BASE;
extern const float ASTEROIDS_CURRENCY_EARNING_BALANCE_MAX;
...
extern const float ASTEROIDS_FINAL_BOSS_WILDBOAR_STATE_BASE_SPEED;
